...
;form:
;	db $1f,$39,"Forma",$ff,$ff,$ff,"Squadra/e",$ff,$ff,$00
;lineup:
;	db $0d,$39,"Scelta",$00
;youneed:
;	db $1f,$39,"Non hai   squadra/e!",$00 ; You need 3 group
;noone:
;	db $1f,$39,"Nessuno in squadra",$ff,$00
